...
class DSTFormer(nn.Module):
    def __init__(self, dim_in=3, dim_out=3, embed_size=256, heads=2, max_len=10, num_joints=17, fusion_depth=5, attn_depth=8, fusion=True):
        ...
        self.joint_embed = nn.Linear(dim_in, embed_size, dtype=torch.float32)
        self.fusion = fusion
        ...
        self.mlp = MLPlayer(embed_size=embed_size, hidden_size=embed_size)
        ...
        self.block = Block(embed_size, spa_heads=2, temp_heads=2, num_layers=2)
